      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          >
            ...
            <span className="bg-primary text-white px-5 py-2 rounded-full font-semibold text-sm transition-all duration-200 hover:opacity-90 mt-6 inline-block w-fit">לחץ לגלות</span>
          </div>
